...
router.post('/assignJobToEquipment', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(30 /* Customer_Equipment_Assign_Job */), validator_1.validate(validator_1.Validations.linkEquipmentJob), customerEquipmentController.linkEquipmentJob);
//Job types
...
//Image upload
router.post('/uploadImage', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(38 /* Image_Upload */), imageController.uploadImage);
//Group
router.post('/createGroup', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(39 /* Group_Create */), validator_1.validate(validator_1.Validations.createGroup), groupController.createGroup);
router.post('/getGroups', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(40 /* Group_Get_All */), groupController.getGroups);
router.post('/deleteGroup', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(41 /* Group_Delete */), validator_1.validate(validator_1.Validations.groupGeneric), groupController.deleteGroup);
router.post('/addGroupManager', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(42 /* Group_Add_Manager */), validator_1.validate(validator_1.Validations.addManager), groupController.addManager);
router.post('/addGroupMember', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(43 /* Group_Add_Member */), validator_1.validate(validator_1.Validations.memberGeneric), groupController.addMember);
router.post('/removeGroupMember', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(44 /* Group_Remove_Member */), validator_1.validate(validator_1.Validations.memberGeneric), groupController.removeMember);
//Company Equipment
router.post('/createCompanyEquipment', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(45 /* Company_Equipment_Create */), validator_1.validate(validator_1.Validations.createCompanyEquipment), companyEquipmentController.createCompanyEquipment);
router.post('/getCompanyEquipments', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(46 /* Company_Equipment_Get */), companyEquipmentController.getCompanyEquipments);
// Company Equipment History
router.post('/equipmentCheckInOut', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(47 /* Company_Equipment_Check_In_Out */), validator_1.validate(validator_1.Validations.createCompanyEquipmentHistory), companyEquipmentHistoryController.createCompanyEquipmentHistory);
// Company Equipment Inventory
router.post('/takeInventory', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(48 /* Inventory_Take */), validator_1.validate(validator_1.Validations.createEquipmentInventory), companyEquipmentInventoryController.createCompanyEquipmentInventory);
router.post('/getInventoryReport', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(49 /* Inventory_Report */), companyEquipmentInventoryController.getIventoryHistory);
// Company cards
router.post('/addCompanyCard', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(50 /* Company_Card_Add */), validator_1.validate(validator_1.Validations.addCompanyCard), companyCardController.createCompanyCard);
router.post('/removeCompanyCard', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(52 /* Company_Card_Remove */), validator_1.validate(validator_1.Validations.removeCompanyCard), companyCardController.removeCompanyCard);
router.post('/getCompanyCards', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(51 /* Company_Card_Get */), companyCardController.getCompanyCards);
// place tags orders
router.post('/placeOrder', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(53 /* Tags_Place_Order */), validator_1.validate(validator_1.Validations.placeOrder), orderController.placeOrder);
router.post('/getOrders', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(54 /* Tags_Get_Orders */), orderController.getOrders);
router.post('/buySubscriptions', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(55 /* Subscription_Buy */), validator_1.validate(validator_1.Validations.buySubscriptions), subscriptionController.addCompanySubscriptions);
router.post('/cancelSubscriptions', passport_1.default.authenticate('jwt', { session: false }), company_1.getCompnayId(), permissions_1.checkUserPermissions(56 /* Subscription_Cancel */), validator_1.validate(validator_1.Validations.buySubscriptions), subscriptionController.removeCompanySubscriptions);
