...
exports.Validations = {
    ...
    //Customers
    createCustomer: [express_validator_1.check('name').exists(), express_validator_1.check('email').exists()],
    updateCustomer: [express_validator_1.check('customerId').exists(), express_validator_1.check('email').exists(), express_validator_1.check('name').exists()],
